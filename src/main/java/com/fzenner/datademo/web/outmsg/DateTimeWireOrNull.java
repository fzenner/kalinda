 ...
 * The problem it solves is the distinction between no change of a value and a change to null.
 * If there is no change, null will be set as overall value and the JSON will not contain a value field.
 * If there is a change to null, the JSON object of the form {value: null} will be set over the wire.
 *
 * @param value
 */
